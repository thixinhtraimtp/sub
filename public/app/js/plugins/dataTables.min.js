...
!function(n) {
                    ...
                    for (g = T.length - 1; 0 <= g; g--) {
                        ...
                        b = I.length; v < b; v++) {
                            ...
                            if ("number" == typeof A && 0 <= A) {
                                ...
                                for (y = 0,
                                D = C.length; y < D; y++)
                                    -1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function(e) {
                                        e = B(e[y].cell);
                                        "_all" !== (A = A.match(/^[a-z][\w-]*$/i) ? "." + A : A) && !e.is(A) || _(y, x)
                                    })
                        }
                    }
                if (w)
    ...
    B.extend($.ext.classes, {
        ...
        paging: {
            active: "current",
            button: "dt-paging pagination-style-1-button",
            container: "dt-paging pagination-style-1",
            disabled: "disabled"
        }
    }),
    {}), d = /[\r\n\u2028]/g, F = /<.*?>/g, L = /^\d{2,4}[./-]\d{1,2}[./-]\d{1,2}([T ]{1}\d{1,2}[:.]\d{2}([.:]\d{2})?)?$/, N = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")","g"), j = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, y = function(e) {
        ...
        return s[t] || (s[t] = new RegExp(je(t),"g")),
        "string" == typeof e && "." !== t ? e.replace(/\./g, "").replace(s[t], ".") : e
    }, h = function(e, t, n) {
        var a = []
          , r = 0
          , o = e.length;
    ...
    function ve(e, t, n, a) {
        ...
        if (null === c.nTr) {
            ...
            s = e.aoColumns.length; l < s; l++) {
                i = e.aoColumns[l],
                (o = (u = !n) ? _.createElement(i.sCellType) : a[l]) || Z(e, 0, "Incorrect column count", 18),
                o._DT_CellIndex = {
                    row: t,
                    column: l
                },
    ...
    function ye(e, t) {
        var n, a, r, o = e.oClasses, i = e.aoColumns, l = "header" === t ? e.nTHead : e.nTFoot, s = "header" === t ? "sTitle" : t;
        if (l) {
            if (0 === B("th, td", l).length && ("header" === t || h(e.aoColumns, s).join("")))
                for (r = B("<tr/>").appendTo(l),
                n = 0,
                a = i.length; n < a; n++)
                    B("<th/>").html(i[n][s] || "").appendTo(r);
            var u = Ce(e, l, !0);
            "header" === t ? e.aoHeader = u : e.aoFooter = u,
            B(l).children("tr").attr("role", "row"),
            B(l).children("tr").children("th, td").each(function() {
                Qe(e, t)(e, B(this), o)
            })
        }
    }
    ...
    function Se(e) {
        var t = e.oLanguage
          , n = t.sZeroRecords
          , a = te(e);
        return e.iDraw <= 1 && ("ajax" === a || "ssp" === a) ? n = t.sLoadingRecords : t.sEmptyTable && 0 === e.fnRecordsTotal() && (n = t.sEmptyTable),
        B("<tr/>").append(B("<td />", {
            colSpan: H(e),
    ...
    function Te(e, t, n) {
        for (var a = {}, r = (B.each(t, function(e, t) {
            var n;
            null === t || (e = e.replace(/([A-Z])/g, " $1").split(" "),
            a[e[0]] || (a[e[0]] = {}),
            n = 1 === e.length ? "full" : e[1].toLowerCase(),
            e = a[e[0]],
            B.isPlainObject(t) ? t.contents ? e[n] = t : e[n] = {
                contents: Object.keys(t).map(function(e) {
                    return {
                        feature: e,
                        opts: t[e]
                    }
            ...
            Array.isArray(e[n].contents)) || (e[n].contents = [e[n].contents])
        }),
        ...
        []), i = 0, l = r.length; i < l; i++)
            ...
            we(e, o[o.length - 1]),
            delete r[i].val.full),
            Object.keys(r[i].val).length && (o.push(r[i].val),
            we(e, o[o.length - 1]));
        return o
    }
    function we(o, i) {
    ...
    function _e(t) {
        var a, e = t.oClasses, n = B(t.nTable), r = B("<div/>").attr({
            ...
            class: e.container
        }).insertBefore(n), e = (t.nTableWrapper = r[0],
        Te(t, t.layout, "top")), n = Te(t, t.layout, "bottom"), o = Qe(t, "layout");
        if (t.sDom)
            for (var i, l, s, u, c, d, f = t, h = t.sDom, p = r, g = h.match(/(".*?")|('.*?')|./g), m = 0; m < g.length; m++)
                i = null,
                "<" == (l = g[m]) ? (s = B("<div/>"),
                "'" != (u = g[m + 1])[0] && '"' != u[0] || (u = u.replace(/['"]/g, ""),
                c = "",
                ...
                m++),
                p.append(s),
                p = s) : ">" == l ? p = p.parent() : "t" == l ? i = He(f) : $.ext.feature.forEach(function(e) {
        ...
        h.oFeatures.bProcessing && (a = B("<div/>", {
            ...
            role: "status"
        }).html(h.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>").insertBefore(e),
    ...
    function Ie(n, e, a) {
        ...
        "function" == typeof o ? n.jqXHR = o.call(i, e, t, n) : "" === o.url ? t({}) : (n.jqXHR = B.ajax(l),
        r && (o.data = r))
    }
    function Ae(e, t, n) {
        var a = "data";
    ...
    function Ve(l, e, t, n, s) {
        Je(e, t, function(o) {
            var i = void 0 === n ? le(o.target) : [n];
            i.length && (w(l, !0),
            setTimeout(function() {
                for (var e, n, t = 0, a = i.length; t < a; t++) {
                    var r = o.shiftKey || 0 < t;
                    !function(e, t, n) {
                        function a(e, t) {
                            var n = e._idx;
                            return (n = void 0 === n ? l.indexOf(e[1]) : n) + 1 < l.length ? n + 1 : t ? null : 0
                        }
                        var r, o = e.aoColumns[t], i = e.aaSorting, l = o.asSorting;
                        o.bSortable && ("number" == typeof i[0] && (i = e.aaSorting = [i]),
                        n && e.oFeatures.bSortMulti ? -1 !== (o = h(i, "0").indexOf(t)) ? null === (r = null === (r = a(i[o], !0)) && 1 === i.length ? 0 : r) ? i.splice(o, 1) : (i[o][1] = l[r],
                        i[o]._idx = r) : (i.push([t, l[0], 0]),
                        i[i.length - 1]._idx = 0) : i.length && i[0][0] == t ? (r = a(i[0]),
                        i.length = 1,
                        i[0][1] = l[r],
                        i[0]._idx = r) : (i.length = 0,
                        i.push([t, l[0]]),
                        i[0]._idx = 0))
                    }(l, i[t], r)
                }
    ...
    function Be(n, a, e) {
        function t(e) {
            var t;
            B.isPlainObject(e) ? void 0 !== e.idx ? a.push([e.idx, e.dir]) : e.name && -1 !== (t = h(n.aoColumns, "sName").indexOf(e.name)) && a.push([t, e.dir]) : a.push(e)
        }
    ...
    function $e(e) {
        var t, n, a, r = e.aLastSort, o = e.oClasses.order.position, i = qe(e), l = e.oFeatures;
    ...
    t("draw()", function(t) {
        return this.iterator("table", function(e) {
            "page" === t ? S(e) : c(e, !1 === (t = "string" == typeof t ? "full-hold" !== t : t))
        })
    }),
    t("page()", function(t) {
    ...
    var ct = function(e, t) {
      ...
      , dt = (t("rows()", function(a, l) {
        void 0 === a ? a = "" : B.isPlainObject(a) && (l = a,
        a = ""),
        l = rt(l);
        var e = this.iterator("table", function(e) {
            ...
            "current" !== o.order && "applied" !== o.order || (n = r.aiDisplayMaster,
            t.sort(function(e, t) {
                return n.indexOf(e) - n.indexOf(t)
            })),
            t;
    ...
    function(e, t) {
      ...
      , mt = (t(gt, function(e, t) {
        var n = this.context;
        return void 0 === e ? n.length && this.length ? n[0].aoData[this[0]]._details : void 0 : (!0 === e ? this.child.show() : !1 === e ? ht(this) : n.length && this.length && it(n[0], n[0].aoData[this[0]], e, t),
        this)
    }),
          ...
          , e = this.iterator("column", function(e, t) {
            ...
            !function(e, t, n) {
                ...
                if (i.bVisible === n)
                    return !1;
                if (n)
                    for (var s = h(o, "bVisible").indexOf(!0, t + 1), u = 0, c = l.length; u < c; u++)
                        l[u] && (r = l[u].nTr,
                        a = l[u].anCells,
                        r) && r.insertBefore(a[t], a[s] || null);
                else
                    B(h(e.aoData, "anCells", t)).detach();
                return i.bVisible = n,
                Xe(e),
                !0
            }(e, t, n) || r.push(t)
    ...
    $.defaults = {
        ...
        ajax: null,
        aLengthMenu: [
            [10, 25, 50, 100, 500, 1000, 5000, 10000, -1], 
            [10, 25, 50, 100, 500, 1000, 5000, 10000, "All"]
        ],
        aoColumns: null,
        aoColumnDefs: null,
        aoSearchCols: [],
        ...
        oLanguage: {
            ...
            sEmptyTable: 
             ...
             `,
            sInfo: "Hiển thị _START_ đến _END_ trong số _TOTAL_",
            sInfoEmpty: "Hiển thị 0 đến 0 trong tổng số 0 mục",
            sInfoFiltered: "(Được lọc từ tổng số 90 mục)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    function Dt(e, t, n) {
        ...
        if (q.moment) {
            ...
            t ? (yt || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),
            yt = !0) : a = new Date(e);
        return a
    }
    function xt(s) {
        return function(a, r, o, i) {
            ...
            function(e, t) {
                ...
                "type" === t ? l : "" === e ? "sort" !== t ? "" : Dt("0000-01-01 00:00:00", null, o) : !(null === r || a !== r || "sort" === t || "type" === t || e instanceof Date) || null === (n = Dt(e, a, o)) ? e : "sort" === t ? n : (e = null === r ? bt(n, "toDate", "toJSDate", "")[s]() : bt(n, "format", "toFormat", "toISOString", r),
                "display" === t ? u(e) : e)
            }
        }
    }
    ...
    if (void 0 !== q.Intl)
        try {
            for (var wt = (new Intl.NumberFormat).formatToParts(100000.1), a = 0; a < wt.length; a++)
                "group" === wt[a].type ? St = wt[a].value : "decimal" === wt[a].type && (Tt = wt[a].value)
        } catch (e) {}
        ...
        header: {
            _: function(d, f, h) {
                ...
                "disable" === f.attr("data-dt-order") || "disable" === f.parent().attr("data-dt-order") || !0 === e && 0 !== n || !1 === e && n !== t.length - 1 || B(d.nTable).on("order.dt.DT", function(e, t, n) {
                    ...
                    f.removeClass(c.isAsc + " " + c.isDesc).toggleClass(c.none, !r).toggleClass(c.canAsc, r && s.includes("asc")).toggleClass(c.canDesc, r && s.includes("desc")),
                    -1 !== (s = l.indexOf(i.toArray().join(","))) && (u = u.order(),
                    f.addClass(u.includes("asc") ? c.isAsc : "" + u.includes("desc") ? c.isDesc : "")),
                    0 === s && l.length === i.count() ? (u = n[0],
                    c = a.asSorting,
                    f.attr("aria-sort", "asc" === u.dir ? "ascending" : "descending"),
                    o = c[u.index + 1] ? "Reverse" : "Remove") : f.removeAttr("aria-sort"),
                    f.attr("aria-label", r ? a.ariaTitle + t.api.i18n("oAria.orderable" + o) : a.ariaTitle),
                    r) && (f.find(".dt-column-title").attr("role", "button"),
                    f.attr("tabindex", 0))
                })
            }
        },
    ...
    function At(e, t, n) {
        var a = []
          , r = Math.floor(n / 2);
        return t <= n ? a = f(0, t) : 1 === n ? a = [e] : 3 === n ? e <= 1 ? a = [0, 1, "ellipsis"] : t - 2 <= e ? (a = f(t - 2, t)).unshift("ellipsis") : a = ["ellipsis", e, "ellipsis"] : e <= r ? (a = f(0, n - 2)).push("ellipsis", t - 1) : (t - 1 - r <= e ? a = f(t - (n - 2), t) : ((a = f(e - r + 2, e + r - 1)).push("ellipsis", t - 1),
    ...
    $.feature.register("search", function(n, e) {
        ...
        (s = B("<div>").addClass(t.container).append(l.replace(/_INPUT_/, o))).find("label").attr("for", "dt-search-" + Ct),
    ...
    $.feature.register("paging", function(e, t) {
        ...
        function n() {
            !function e(t, n, a) {
                ...
                h.length && 1 < a.numbers && B(n).outerHeight() >= 2 * B(h[0]).outerHeight() - 10 && e(t, n, B.extend({}, a, {
                    numbers: a.numbers - 2
                }))
            }(e, a, t)
        }
    ...
    return $.feature.register("pageLength", function(a, e) {
        ...
        return c.find("label").attr("for", "dt-length-" + Ft),
