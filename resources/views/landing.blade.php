...
<head>
    ...
    <title>{{ request()->getHost() }} HỆ THỐNG DỊCH VỤ MẠNG XÃ HỘI, SOCIAL MEDIA MARKETING 2025 | {{ request()->getHost() }}</title>
    <meta name="description" content="{{ siteValue('description') }}">
    <meta name="keywords" content="{{ siteValue('keywords') }}">
    <meta name="author" content="{{ siteValue('author') }}">
    <meta name="robots" content="index, follow">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark osahan-nav">
            <div class="container">
                <a class="navbar-brand text-dark font-weight-bold" href="{{ route('home') }}">
                    <img class="logo" src="{{ siteValue('logo') }}" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-2">
                            <a class="nav-link" href="{{ route('login') }}">Dịch Vụ</a>
                        </li>
                    </ul>
            ...
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-md-8 mx-auto text-center header-title">
                        <div class="slideanim">
                            <h1 class="font-weight-bold mb-4">{{ Str::upper(request()->getHost()) }} HỆ THỐNG DỊCH VỤ MẠNG XÃ HỘI, SOCIAL MEDIA
                                MARKETING 2025</h1>
            ...
            <section class="py-5 border-bottom slideanim">
                ...
                <div class="row d-flex align-items-center mb-5">
                    ...
                    <div class="col-md-6 pl-lg-5">
                        <p class="m-0">{{ request()->getHost() }} là việc sử dụng các nền tảng truyền thông xã hội như Instagram,
                    ...
                    <div class="col-md-6 d-flex align-items-center mb-4">
                        ...
                        <span>
                            ...
                            <p class="mb-0 learn-more">
                                <a href="{{ route('login') }}" class="text-decoration-none">Tìm hiểu thêm<i
                ...
                <div class="row mt-lg-3">
                    <div class="col-md-6 d-flex align-items-center mb-4">
                        ...
                        <span href="#" class="text-decoration-none">
                            ...
                            <p class="mb-0 learn-more">
                                <a href="{{ route('login') }}" class="text-decoration-none">Tìm hiểu thêm
    ...
    <footer class="bg-light slideanim py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <a class="navbar-brand text-dark font-weight-bold" href="{{ route('landing') }}">
                        <img class="footer-logo" src="{{ siteValue('logo') }}" alt="logo">
                    </a>
                ...
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled m-0">
                        ...
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Đặc trưng</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Tài liệu</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Giới thiệu</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Định giá
                        </li>
                    </ul>
                </div>
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled m-0">
                        ...
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Thiết kế</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Chủ đề</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Minh họa</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">UI kit</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled m-0">
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Liên hệ</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Điều kiện</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Chính sách bảo
                                mật</a>
                        </li>
                ...
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled m-0">
                        ...
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Giấy phép</a>
                        </li>
                        <li>
                            <a href="{{ route('home') }}#" class="text-decoration-none text-dark">Hỗ trợ</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="py-4 osahan-copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="text-dark m-0">© 20{{ date('y') }} {{ Str::upper(request()->getHost()) }}. Quản lý
                        vận hành bởi : {{ siteValue('author') }}.</p>
                </div>
            </div>
        </div>
    </div>
...
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>{{strtoupper(siteValue('name_site'))}} SMM Panel - Social Services</title>
    <meta name="description" content="{{ siteValue('description') }}">
    <meta name="keywords" content="{{ siteValue('keywords') }}">
    <meta name="author" content="{{ siteValue('author') }}">
    <meta name="robots" content="index, follow">
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <!--begin::Logo image-->
                                <a href="/">
                                    <img alt="Logo" src="{{siteValue('logo')}}" class="logo-default h-25px h-lg-25px" />
                                    <img alt="Logo" src="{{siteValue('logo')}}" class="logo-sticky h-20px h-lg-25px" />
                                </a>
                                <!--end::Logo image-->
                            </div>
                            <!--end::Logo-->
                                    ...
                                    <div class="menu-item">
                                        <div class="menu-content text-center">
                                            <div class="text-gray-400">New Here ?
                                                <a href="{{ route('home') }}" class="link-primary fw-bolder">Create an
                                                    Account</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        ...
                        <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">Hệ thống Dịch Vụ MXH rẻ nhất!
                            ...
                            <span
                                ...
                                <span id="kt_landing_hero_text">{{strtoupper(siteValue('name_site'))}} SMM Panel -
                        ...
                        <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                            ...
                            <div class="rounded landing-dark-border p-9 mb-10">
                                ...
                                <span class="fw-normal fs-4 text-gray-700">Email us to
                                    <a href="#"
                                        class="text-white opacity-50 text-hover-primary">{{strtoupper(siteValue('name_site'))}}</a></span>
                                <!--end::Text-->
                            </div>
                            <!--end::Block-->
                            <!--begin::Block-->
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="d-flex fw-bold flex-column ms-lg-20">
                                    ...
                                    <a href="#" class="mb-6">
                                        ...
                                        <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">{{site('telegram')}}</span>
                                    </a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                                    <a href="#" class="mb-6">
                                        ...
                                        <span
                                            class="text-white opacity-50 text-hover-primary fs-5 mb-6">{{site('zalo')}}</span>
                                    </a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Links-->
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            <!--begin::Logo-->
                            <a href="/">
                                <img alt="Logo" src="{{siteValue('logo')}}" class="h-15px h-md-20px" />
                            </a>
                            <!--end::Logo image-->
                            <!--begin::Logo image-->
                            <span class="mx-5 fs-6 fw-bold text-gray-600 pt-1" href="/">© 2022
                                {{strtoupper(siteValue('name_site'))}} SMM Panel - Social Services</span>
                            <!--end::Logo image-->
                        </div>
                        <!--end::Copyright-->
                    </div>
...
<html lang="en">
  <head>
    ...
    <title> {{ site('name_site') }} | Hệ thống dịch vụ Mạng Xã Hội </title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-7">
            ...
            >
              <span class="dela-font">{{ site('name_site') }} - #1</span> Cheapest SMM Panel
            ...
            <p class="txt" data-aos="fade-right" data-aos-duration="1500">
              ...
              panel in a distance of a click. {{ site('name_site') }} is a SMM Panel with
        ...
        <div class="row feature-row">
          <div class="col-sm-4">
            ...
            >
              ...
              <p class="feature-txt">
                {{ site('name_site') }} offer Free Child Panel like us ( different design )
          ...
          <div class="col-sm-4">
            ...
            >
              ...
              <p class="feature-txt">
                {{ site('name_site') }} offer cheapest price services in whole market.
                {{ site('name_site') }} can beat any smm reseller panel in market.
              </p>
            </div>
          </div>
          <div class="col-sm-4">
        ...
        >
          ...
          <div class="col-sm-8">
            ...
            <p class="txt">
              ...
              needs can be a tedious job! Check why you should trust {{ site('name_site') }}
            ...
            <p class="txt">
              ...
              accounts, at {{ site('name_site') }} all purchase are made safe using Sucure
            ...
            >
              ...
              <div class="testi-body">
                ...
                <p class="testi-txt">
                  ...
                  never got a delay! {{ site('name_site') }} did a great job always.
          ...
          <div class="col-sm-3">
            ...
            >
              ...
              <div class="testi-body">
                ...
                <p class="testi-txt">
                  I was looking for indian smm panel and found {{ site('name_site') }}.
            ...
            >
              ...
              <div class="testi-body">
                ...
                <p class="testi-txt">
                  ...
                  promised in time! Happy to Purchased from {{ site('name_site') }}. We will
                  Continue with {{ site('name_site') }} as smm panel india for our future
                  purchase.
                </p>
              </div>
            </div>
          ...
          <div class="row d-flex align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
              <div class="banner_content">
                <h1>
                  <span class="title_top">{{ site('name_site') }}'s - #1</span> <br />
                  Cheap SMM Panel <br />
                  For Resellers
                </h1>
                <p>296990 Orders until now!</p>
                <div class="mt-2">
                  <a href="{{ route('home') }}" class="btn btn-hero">Sign up now</a>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
              <h2 class="why_title">
                Why Choose {{ site('name_site') }} as a Best SMM reseller panel?
              </h2>
            </div>
          </div>
        </div>
              ...
              <div class="why_item">
                <div class="why_item_wrap">
                  ...
                  <div class="why_content">
                    ...
                    <p>
                      {{ site('name_site') }} offer Free Child Panel like us ( different
          ...
          <div class="row d-flex align-items-center">
            <div class="col-lg-5 col-md-5 col-sm-12 col-12">
              <div class="def_sec_content">
                ...
                <p>
                  {{ site('name_site') }} is the best cheap SMM Panel provider all around
                  the globe. If you want to boost your social media reach,
                  {{ site('name_site') }} is the best option for you, as they provide the
                  best service in cheap.
                </p>
                <div class="def_btn_wrap">
                  <a href="{{ route('home') }}" class="btn def_btn">Sign up Now</a>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 mb-5">
              <div class="sec_title mb-5">
                <h4 class="top_sm_title">{{ site('name_site') }} Accept</h4>
          ...
          <div class="row d-flex align-items-center">
            <div class="col-lg-5 col-md-5 col-sm-12 col-12">
              <div class="def_sec_content">
                ...
                <p>
                  {{ site('name_site') }} is the greatest SMM reseller panel because it
              ...
              <div class="testimonials_wraper">
                ...
                <div class="testimoni_content">
                  <p class="mb-4">
                    ...
                    definitely will use {{ site('name_site') }} again .
                  </p>
                  <img
                    src="https://cdn.nmhpanel.com/landing/3/imgs/star-5_nwmec3.png"
                    class="img-fluid"
          ...
          <div class="row d-flex align-items-center">
            <div class="col-lg-5 col-md-5 col-sm-12 col-12">
              <div class="def_sec_content">
                ...
                <p>
                  The most reliable SMM Panel in the market is {{ site('name_site') }}.
                ...
                <p>
                  ...
                  strategy. So to get started with {{ site('name_site') }} as the cheapest
        ...
        <div class="row footer_top">
          <div class="col-lg-4 col-md-12 col-sm-12 col-12">
            <div class="footer_v2_logo">
              <a href="{{ route('home') }}">
                <img src="{{ siteValue('logo') }}" class="footer_logo" alt="smm panel" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="footer_bottom_links text-center">
              <span class="link">© Copyright 2025 {{ site('name_site') }} </span>
    ...
    <nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/">
            <img src="{{ siteValue('logo') }}" alt="{{ site('name_site') }}" title="" />
          </a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <div class="col-sm-12">
              ...
              <form class="home-form form-inline" style="display: none;">
                ...
                <span class="pull-left pull-left-middle"
                  >Do not have an account? <a href="{{ route('home') }}">Sign up</a></span
                >
              </form>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-6">
              <div class="media hvr-bob">
                ...
                <div class="media-body">
                  ...
                  <p>
                    We have the friendliest dashbord in the {{ site('name_site') }}! Updated
            ...
            <div class="col-sm-6">
              <div class="media hvr-bob">
                ...
                <div class="media-body">
                  ...
                  <p>
                    We are proud to have the best support in the {{ site('name_site') }},
          ...
          <div class="row title-row">
            <div class="col-sm-12">
              ...
              <p class="title-bottom-txt">
                {{ site('name_site') }} and our dedicated team are all set to give you and
            ...
            <div class="col-sm-3">
              <div class="work-wrap">
                ...
                <div class="work-bottom">
                  <p>
                    Register into our {{ site('name_site') }}, fill up your data and get
                    ready to be famous.
                  </p>
                </div>
              </div>
              ...
              <div class="feature-slider">
                  ...
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        ...
                        no farther than {{ site('name_site') }}. All your SMM needs are
                  ...
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        ...
                        {{ site('name_site') }} is the world's best SMM Panel
                      </p>
                    </div>
                  </div>
                </div>
                <div>
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        You can contact {{ site('name_site') }} to buy SMM Panel Wholesale
                  ...
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        ...
                        to ensure 100% customer satisfaction. {{ site('name_site') }} is the
                ...
                <div>
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        {{ site('name_site') }} provides the most reliable and cost-efficient
                  ...
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        ...
                        panel services,<br />
                        look no farther than {{ site('name_site') }}.<br />
                  ...
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        ...
                        than {{ site('name_site') }}. We beat any price without making any
                ...
                <div>
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        If you contact {{ site('name_site') }} to meet your (SMM) Social
                ...
                <div>
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        {{ site('name_site') }} is the most reliable SMM Provider Panel
                ...
                <div>
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        At {{ site('name_site') }}, we have a professional and cheap reseller
                  ...
                  <div class="feature-slider-wrap">
                    ...
                    <div class="feature-icon">
                      <p>
                        ...
                        {{ site('name_site') }}. Our fully automated Social SMM Panel USA
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-5">
              ...
              <a href="{{ route('home') }}" class="world-btn"
      ...
      <section id="ready">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-6">
              <a href="{{ route('home') }}" class="joinBtn">Join us now</a>
            </div>
          </div>
        </div>
      </section>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <div class="ftr-logo">
              <img src="{{ siteValue('logo') }}" alt="ftr-logo" height="45px" />
            </div>
            <div class="ftr-txt">
              <p>
                {{ site('name_site') }} #Destination No.1 SMM PANEL Social Media Services
                Provider
              </p>
            </div>
            <div class="ftr-info">
              <a href="#" target="_blank"
                ><i class="fas fa-map-marker-alt"></i> {{ site('name_site') }}</a
              >
          ...
          <div class="col-sm-6">
            <div class="ftr-nav">
              ...
              <ul>
                ...
                <li><a href="/terms">terms</a></li>
                <li><a>faqs</a></li>
                <li><a href="{{ route('home') }}">signin</a></li>
                <li><a href="{{ route('home') }}">signup</a></li>
              </ul>
            </div>
          </div>
        </div>
