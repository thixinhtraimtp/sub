        ...
        <div class="page">
            ...
            <aside class="app-sidebar sticky" id="sidebar">
                ...
                <div class="main-sidebar-header">
                    <a href="index.html" class="header-logo">
                    <img src="{{siteValue('logo')}}" alt="logo" class="desktop-logo" /> <img src="{{siteValue('logo')}}" alt="logo" class="toggle-logo" />
                    <img src="{{siteValue('logo')}}" alt="logo" class="desktop-dark" /> <img src="{{siteValue('logo')}}" alt="logo" class="toggle-dark" />
                    </a>
                </div>
                <div class="main-sidebar" id="sidebar-scroll">
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.user.history') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.history.payment') }}" class="side-menu__item">
                                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24">
                                        <g fill="none">
                                            <circle cx="12" cy="12" r="9" fill="currentColor" opacity="0.16"/>
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.636 18.364A9 9 0 1 0 3 12.004V14"/>
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.history.orders') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.history.product.orders') }}" class="side-menu__item">
                                    <i class="bx bx-cart side-menu__icon"></i>
                            ...
                            @endif
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.affiliates') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.website.partner') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.payment.config') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.cron') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide__category"><span class="category-name">Services & Products</span></li>
                             @if (request()->getHost() === env('APP_MAIN_SITE'))
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.product.category') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.service.smm') }}" class="side-menu__item">
                            ...
                            @if (request()->getHost() === env('APP_MAIN_SITE'))
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.service.platform') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.server') }}" class="side-menu__item">
                            ...
                            @endif
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.voucher') }}" class="side-menu__item">
                            ...
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.notify') }}" class="side-menu__item">
                                <i class="bx bx-bell side-menu__icon"></i>
                                <span class="side-menu__label">Thông báo</span>
                                </a>
                            </li>
                            <li class="mt-1 slide">
                                <a href="{{ route('admin.ticket.ticket') }}" class="side-menu__item">
                                    <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24">
