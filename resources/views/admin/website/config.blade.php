...
@section('content')
<form action="{{ route('admin.website.update') }}" method="POST" id="theme" hidden>
    @csrf 
    <div class="row">
                        ...
                        <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <option value="off"
                                                        {{ siteValue('maintain') == 'off' ? 'selected' : '' }}>Tắt
                                                        </option>
                                                        <option value="on"
                                                        {{ siteValue('maintain') == 'on' ? 'selected' : '' }}>Bật
                                                        </option>
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="madon" name="madon"
                                                            placeholder="Nhập dữ liệu" value="{{ siteValue('madon') }}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <option value="on"
                                                        {{ siteValue('confirm_payment') == 'on' ? 'selected' : '' }}>Bật
                                                        </option>
                                                        <option value="off"
                                                        {{ siteValue('confirm_payment') == 'off' ? 'selected' : '' }}>Tắt
                                                        </option>
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="collaborator" name="collaborator" placeholder="Nhập dữ liệu" value="{{ siteValue('collaborator') }}">
                                                        <label for="collaborator">Mức nạp Cộng Tác Viên</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="agency" name="agency" placeholder="Nhập dữ liệu" value="{{ siteValue('agency') }}">
                                                        <label for="agency">Mức nạp Đại Lý</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="distributor" name="distributor" placeholder="Nhập dữ liệu" value="{{ siteValue('distributor') }}">
                                                        <label for="distributor">Mức nạp Nhà Phân Phối</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control " name="price" value="{{ siteValue('price') }}" placeholder="Name">
                                                        <label><span class=" ps-3">Chiết khấu thành viên</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control " name="price_collaborator" value="{{ siteValue('price_collaborator') }}" placeholder="Name">
                                                        <label><span class=" ps-3">Chiết khấu CTV</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control " name="price_agency" value="{{ siteValue('price_agency') }}" placeholder="Name">
                                                        <label><span class=" ps-3">Chiết khấu đại lý</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control " name="price_distributor" value="{{ siteValue('price_distributor') }}" placeholder="Name">
                            ...
                            <div class="tab-pane" id="tab-2" role="tabpanel">
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <form id="website-update" action="{{ route('admin.website.update') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="nameadmin" name="nameadmin"
                                                            placeholder="Nhập dữ liệu" value="{{ siteValue('nameadmin') }}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="avatar_admin" name="avatar_admin"
                                                            placeholder="Nhập dữ liệu" value="{{ siteValue('avatar_admin') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <option value="on"
                                                        {{ siteValue('status_massorder') == 'on' ? 'selected' : '' }}>Hiện
                                                        </option>
                                                        <option value="off"
                                                        {{ siteValue('status_massorder') == 'off' ? 'selected' : '' }}>Ẩn
                                                        </option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <select name="status_smm" id="status_smm" class="form-select">
                                                                <option value="on"
                                                                    {{ siteValue('status_smm') == 'on' ? 'selected' : '' }}>Hiện
                                                                </option>
                                                                <option value="off"
                                                                    {{ siteValue('status_smm') == 'off' ? 'selected' : '' }}>Ẩn
                                                                </option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <select name="status_services" id="status_services" class="form-select">
                                                                <option value="on"
                                                                    {{ siteValue('status_services') == 'on' ? 'selected' : '' }}>Hiện
                                                                </option>
                                                                <option value="off"
                                                                    {{ siteValue('status_services') == 'off' ? 'selected' : '' }}>Ẩn
                                                                </option>
                                                            </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <select name="theme_admin" id="theme_admin" class="form-select">
                                                            ...
                                                            <option value="1"
                                                            {{ siteValue('theme_admin') == '1' ? 'selected' : '' }}>Xanh Biển
                                                            </option>
                                                            <option value="2"
                                                            {{ siteValue('theme_admin') == '2' ? 'selected' : '' }}>Tím đậm
                                                            </option>
                                                            <option value="3"
                                                            {{ siteValue('theme_admin') == '3' ? 'selected' : '' }}>Tím
                                                            </option>
                                                            <option value="4"
                                                            {{ siteValue('theme_admin') == '4' ? 'selected' : '' }}>Hồng
                                                            </option>
                                                            <option value="5"
                                                            {{ siteValue('theme_admin') == '5' ? 'selected' : '' }}>Đỏ
                                                            </option>
                                                            <option value="6"
                                                            {{ siteValue('theme_admin') == '6' ? 'selected' : '' }}>Cam đậm
                                                            </option>
                                                            <option value="7"
                                                            {{ siteValue('theme_admin') == '7' ? 'selected' : '' }}>Cam nhạt
                                                            </option>
                                                            <option value="8"
                                                            {{ siteValue('theme_admin') == '8' ? 'selected' : '' }}>Xanh Lục
                                                            </option>
                                                            <option value="9"
                                                            {{ siteValue('theme_admin') == '9' ? 'selected' : '' }}>Xanh Lá Mạ
                                                            </option>
                                                            <option value="10"
                                                            {{ siteValue('theme_admin') == '10' ? 'selected' : '' }}>Xanh lam
                                                            </option>
                                                        </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3">
                                                        <select name="landing" id="landing" class="form-select">
                                                            ...
                                                            <option value="off"
                                                            {{ siteValue('landing') == 'off' ? 'selected' : '' }}>Ẩn Landing
                                                            </option>
                                                            <option value="0"
                                                            {{ siteValue('landing') == '0' ? 'selected' : '' }}>Mặc định
                                                            </option>
                                                            <option value="1"
                                                            {{ siteValue('landing') == '1' ? 'selected' : '' }}>Landing 1
                                                            </option>
                                                            <option value="2"
                                                            {{ siteValue('landing') == '2' ? 'selected' : '' }}>Landing 2
                                                            </option>
                                                            <option value="3"
                                                            {{ siteValue('landing') == '3' ? 'selected' : '' }}>Landing 3
                                                            </option>
                                                            <option value="4"
                                                            {{ siteValue('landing') == '4' ? 'selected' : '' }}>Landing 4
                                                            </option>
                                                        </select>
                                            ...
                                            <!--
                                                <div class="form-floating mb-3">
                                                     <select name="theme" id="theme" class="form-select">
                                                                ...
                                                                <option value="dark"
                                                                    {{ siteValue('theme') == 'dark' ? 'selected' : '' }}>Tối
                                                                </option>
                                                                <option value="light"
                                                                    {{ siteValue('theme') == 'light' ? 'selected' : '' }}>Sáng
                                                                </option>
                                                            </select>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="telegram_chat_id_dontay" name="telegram_chat_id_dontay"
                                                            placeholder="Nhập dữ liệu" value="{{ site('telegram_chat_id_dontay') }}">
                                                    ...
                                                    <div class="form-floating mb-3" hidden>
                                                        <input type="text" class="form-control" id="telegram_chat_id_box" name="telegram_chat_id_box"
                                                            placeholder="Nhập dữ liệu" value="{{ site('telegram_chat_id_box') }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="api_recharge_card"
                                                            ...
                                                            value="{{ configValue('api_recharge_card') }}">
