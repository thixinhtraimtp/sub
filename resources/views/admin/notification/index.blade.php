...
@section('title', 'Quản lí thông báo hệ thống')
@section('content')
<div class="row">
    <div class="col-xl-12">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('admin.notify.system.create') }}" method="POST">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" id="content" name="content" placeholder="Nội dung" style="height: 100px" value="{{ old('content') }}"></textarea>
                                            </div>
                                        ...
                                        <form action="{{ route('admin.website.setting') }}" method="POST">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea class="form-control" id="urgent_notice" name="urgent_notice" placeholder="Nội dung" style="height: 100px">{{ configValue('urgent_notice') }}</textarea>
                                                </div>
                                                <div class="form-group">
