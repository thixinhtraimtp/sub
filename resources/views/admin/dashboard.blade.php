            ...
            <div class="card-body">
                <div class="d-flex align-items-top">
                    ...
                    <div class="flex-fill">
                        <div class="d-flex mb-1 align-items-top justify-content-between">
                            <h5 class="fw-semibold mb-0 lh-1">
                                {{ number_format($totalRenvenueToday) }}                                   
                            </h5>
                        </div>
    ...
    (function () {
      var options_order_statistics = {
        ...
        series: [
          {
            name: 'Đang chờ',
            data: @json($totalOrderStatus['totalPending'])
          },
          {
            name: 'Đang chạy',
            data: @json($totalOrderStatus['totalProcessing'])
          },
          {
            name: 'Đã huỷ',
            data: @json($totalOrderStatus['totalCanceled'])
          },
          {
            name: 'Chờ hoàn tiền',
            data: @json($totalOrderStatus['totalPendingRefundCancel'])
          },
          {
            name: 'Hoàn tiền',
            data: @json($totalOrderStatus['totalRefund'])
          },
          {
            name: 'Hoàn thành',
            data: @json($totalOrderStatus['totalCompleted'])
          }
        ],
        xaxis: {
