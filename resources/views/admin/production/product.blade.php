...
VD: tài khoản | mật khẩu |..."></textarea>
    ...
    <div class="row">
        <div class="col-12 text-right mb-3">
            <a href="{{route('admin.product.category')}}" class="btn btn-primary-gradient">
                            ...
                            <tbody>
                                @foreach ($category->products as $product)
                                    <tr>
                                        <td>{{ $product->id }}</td>
                                        <td>
                                            <a href="{{ route('admin.product.delete', ['id' => $product->id]) }}" class="btn btn-danger-gradient btn-sm"  data-bs-toggle="tooltip" title="Xoá">
