        ...
        <div class="col-lg-12 mb-5">
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    <input disabled="" class="form-control" type="text" value="{{ Auth::user()->api_token }}"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="alert alert-primary border-white text-primary rounded-top-0 fw-bold fs-3 text-center">
                                            <span onclick="coppy('{{ $website->name_sever1 }}')" class="cursor-pointer">{{ $website->name_sever1 }} <i class="fas fa-copy"></i></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="border-top border-start border-end py-2 border-white bg-primary rounded-top-2 mb-0">
                                        ...
                                        <div class="alert alert-primary border-white text-primary rounded-top-0 fw-bold fs-3 text-center">
                                            <span onclick="coppy('{{ $website->name_sever2 }}')" class="cursor-pointer">{{ $website->name_sever2 }} <i class="fas fa-copy"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </strong>
