            ...
            <table class="table align-middle table-row-bordered table-rounded border rounded gy-2 gs-5">
                <tbody>
                    <tr>
                        ...
                        <td class="fw-bolder">https://{{getDomain()}}/api/v2</td>
                    </tr>
                    <tr>
                        <td class="text-gray-700">API Key</td>
                        <td class="fw-bolder"><span class="text-danger" id="key">{{Auth::user()->api_token ?? 'Vui lòng đăng nhập để lấy API Token!'}}</span> <a
