            ...
            <div class="navbar-wrapper">
                ...
                <div class="navbar-content">
                    <ul class="pc-navbar">
                        ...
                        <li class="pc-item"> 
                            <a href="{{route('product.purchased')}}" class="pc-link"> 
                        ...
                        <li class="pc-item">
                            <a href="{{route('affiliate')}}" class="pc-link">
                                <span class="pc-micon">
                        ...
                        <li class="pc-item">
                            <a href="{{route('api')}}" class="pc-link">
                                <span class="pc-micon">
                        ...
                        @if (getDomain() == env('APP_MAIN_SITE'))
                        <li class="pc-item">
                            <a href="{{route('product.categories')}}" class="pc-link">
                            <span class="pc-micon"> 
                        ...
                        <li class="pc-item">
                            <a href="{{route('mass')}}" class="pc-link">
                        ...
                        <li class="pc-item pc-hasmenu">
                            ...
                            <span class="pc-micon">
                            <img src="{{ $platform->image }}" width="24px" height="24px">
                            </span>
                    ...
                    <div class="card nav-action-card bg-brand-color-4">
                        <div class="card-body" style="background-image: url('https://html.phoenixcoded.net/light-able/bootstrap/assets/images/layout/nav-card-bg.svg')">
                            ...
                            <a href="{{route('ticket')}}" class="btn btn-primary" target="_blank">Trung tâm hỗ trợ</a> 
                        </div>
                    </div>
                </div>
                <div class="card pc-user-card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0"> <img src="https://ui-avatars.com/api/?background=random&name={{(Auth::user()->name) ?? 'Bạn chưa đăng nhập'}}" alt="user-image" class="user-avtar wid-45 rounded-circle" /> </div>
                            <div class="flex-grow-1 ms-3">
                                <div class="dropdown">
                                    <a href="#" class="arrow-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="0,20">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1 me-2">
                                                <h6 class="mb-2">{{(Auth::user()->name) ?? 'Bạn chưa đăng nhập'}}</h6>
                                                <span class="badge bg-primary p-2 font-semibold text-sm">Số dư: {{ number_format(Auth::user()->balance ?? 0) ?: '0đ' }}</span>  
                                            </div>
                                    ...
                                    <div class="dropdown-menu">
                                        <ul>
                                            <li> <a href="{{ route('account.profile') }}" class="pc-user-links"><i class="ph-duotone ph-user"></i><span>Tài khoản</span></a></li>
                                            <li> <a href="{{ route('logout') }}" class="pc-user-links"><i class="ph-duotone ph-power"></i> <span>Đăng xuất</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="ms-auto">
                    <ul class="list-unstyled">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 me-3 position-relative">
                                                            <h6 class="mb-0">{!! $noticeService->content !!}</h6>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                            <span class="text-sm">{{ timeago($noticeService->created_at) }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <li class="dropdown pc-h-item header-user-profile">
                            <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false" > <img src="https://ui-avatars.com/api/?background=random&name={{(Auth::user()->name) ?? 'Bạn chưa đăng nhập'}}" alt="user-image" class="user-avtar" /> </a> 
                                ...
                                <div class="dropdown-body">
                                    <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                                        <ul class="list-group list-group-flush w-100">
                                            <li class="list-group-item">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0"> <img src="https://ui-avatars.com/api/?background=random&name={{(Auth::user()->name) ?? 'Bạn chưa đăng nhập'}}" alt="user-image" class="wid-50 rounded-circle" /> </div>
                                                    <div class="flex-grow-1 mx-3">
                                                        <h5 class="mb-0">{{(Auth::user()->name) ?? 'Bạn chưa đăng nhập'}}</h5>
                                                        <h6 class="text-primary"><strong>Số dư: </strong>{{ number_format(Auth::user()->balance ?? 0) ?: '0đ' }}</h6>
                                                    </div>
                                                    <span class="badge bg-primary">{{ levelUser(Auth::user()->level ?? 'Thành viên')}}</span> 
                                                </div>
                                            </li>
                                            <li class="list-group-item"> 
                                                @if (Auth::check())
            ...
            <div class="footer-wrapper container-fluid">
                <div class="row">
                    <div class="col-sm-6 my-1">
                        <strong>
                            <p class="m-0 text-muted">Copyright © 20{{ date('y') }}. <a href="{{ siteValue('facebook') }}" target="_blank">{{ siteValue('name_site') }}</a> - Social Media Marketing.</p>
                        </strong>
                    </div>
