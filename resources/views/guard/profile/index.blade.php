            ...
            <div class="card-body position-relative">
                <div class="text-center mt-3">
                    <div class="chat-avtar d-inline-flex mx-auto">
                        <img class="rounded-circle img-fluid wid-90 img-thumbnail" src="https://ui-avatars.com/api/?background=random&name={{Auth::user()->name}}" alt="User image">
                        <i class="chat-badge bg-success me-2 mb-2"></i>
                    </div>
                    <h5 class="mb-0">{{ Auth::user()->name }}</h5>
                    <p class="text-muted text-sm">DM on <a href="#" class="link-primary"> <span>@</span>{{ Auth::user()->username }} </a> 😍</p>
                    ...
                    <div class="row g-3">
                        <div class="col-4">
                            <h5 class="mb-0">{{ number_format(Auth::user()->balance) }}đ</h5>
                            <small class="text-muted">Số dư</small>
                        </div>
                        <div class="col-4">
                            <h5 class="mb-0">{{ number_format(Auth::user()->total_recharge) }}đ</h5>
                            <small class="text-muted">Tổng nạp</small>
                        </div>
                        <div class="col-4">
                            <h5 class="mb-0">{{ number_format(Auth::user()->total_recharge - Auth::user()->balance, 0, ',', '.') }}đ</h5>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered nowrap dataTable"
                                ...
                                <tbody>
                                    @foreach (\App\Models\UserActivity::where('user_id', Auth::user()->id)->where('activity', 'auth')->orderBy('id', 'DESC')->limit(10)->get() as $activity)
                                    <tr>
