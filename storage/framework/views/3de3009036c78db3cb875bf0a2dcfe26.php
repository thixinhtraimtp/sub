    ...
    <div class="col-md-12 mb-3">
        <div class="row">
            <div class="col-6 d-grid gap-2">
                <a href="<?php echo e(route('account.recharge')); ?>" class="btn btn-primary">
                Ngân hàng</a>
            </div>
            <div class="col-6 d-grid gap-2">
                <a href="<?php echo e(route('account.card')); ?>" class="btn btn-outline-primary">
                Thẻ cào</a>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="alert alert-danger fw-bold border border-white" role="alert" style="display: flex;">
                            <div style="width: 150%;">
                                <div class="mb-2 ">
                                    <img src="<?php echo e(asset($momo->logo)); ?>" alt="Logo momo" width="210" class="text-center">
                                </div>
                                <div class="mb-2">
                                    Số Tài khoản:
                                    <b class="fw-bold cursor-pointer text-success"
                                        onclick="coppy('<?php echo e($momo->account_number); ?>')">
                                    <?php echo e($momo->account_number); ?> <i class="fas fa-copy"></i>
                                    </b>
                                </div>
                                <div class="mb-2">
                                    Chủ tài khoản: <b><?php echo e($momo->account_name); ?></b>
                                </div>
                                <div class="mb-2">
                                    Số tiền tối thiểu: <b><?php echo e(number_format($momo->min_recharge)); ?> VNĐ</b>
                                </div>
                                <div class="mb-2">
                                    Nội dung chuyển khoản:
                                    <b onclick="coppy('<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>')"
                                        class="cursor-pointer text-success">
                                    <?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?> <i
                                        class="fas fa-copy"></i>
                                    </b>
                                </div>
                            ...
                            <div class="qrbank text-center mt-3">
                                <img src="https://momosv3.apimienphi.com/api/QRCode?phone=<?php echo e($momo->account_number); ?>&note=<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>&amount="
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="alert alert-success fw-bold border border-white" role="alert"
                            ...
                            <div style="width: 150%;">
                                <div class="mb-2 ">
                                    <img src="<?php echo e(asset($vietcombank->logo)); ?>" alt="Logo vietcombank" width="100"
                                        class="text-center">
                                </div>
                                <div class="mb-2">
                                    Số Tài khoản:
                                    <b class="fw-bold cursor-pointer text-success"
                                        onclick="coppy('<?php echo e($vietcombank->account_number); ?>')">
                                    <?php echo e($vietcombank->account_number); ?> <i class="fas fa-copy"></i>
                                    </b>
                                </div>
                                <div class="mb-2">
                                    Chủ tài khoản: <b><?php echo e($vietcombank->account_name); ?></b>
                                </div>
                                <div class="mb-2">
                                    Số tiền tối thiểu: <b><?php echo e(number_format($vietcombank->min_recharge)); ?> VNĐ</b>
                                </div>
                                <div class="mb-2">
                                    Nội dung chuyển khoản:
                                    <b onclick="coppy('<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>')"
                            ...
                            <div class="qrbank text-center mt-3">
                                <img src="https://img.vietqr.io/image/vietcombank-<?php echo e($vietcombank->account_number); ?>-qr_only.jpg?accountName=<?php echo e($vietcombank->account_name); ?>&addInfo=<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>&amount="
                                    alt="QR CODE" width="80%">
                            </div>
                            <!-- Modal -->
                            <div class="modal fade text-dark" id="billCreateModalVietcombank" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo e(route('recharge.post')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="alert alert-info border border-white fw-bold" role="alert" style="display: flex;">
                            <div style="width: 150%;">
                                <div class="mb-2 ">
                                    <img src="<?php echo e(asset($acb->logo)); ?>" alt="Logo ACB" width="100" class="text-center">
                                </div>
                                <div class="mb-2">
                                    Số Tài khoản:
                                    <b class="fw-bold cursor-pointer text-success"
                                        onclick="coppy('<?php echo e($acb->account_number); ?>')">
                                    <?php echo e($acb->account_number); ?> <i class="fas fa-copy"></i>
                                    </b>
                                </div>
                                <div class="mb-2">
                                    Chủ tài khoản: <b><?php echo e($acb->account_name); ?></b>
                                </div>
                                <div class="mb-2">
                                    Số tiền tối thiểu: <b><?php echo e(number_format($acb->min_recharge)); ?> VNĐ</b>
                                </div>
                                <div class="mb-2">
                                    Nội dung chuyển khoản:
                                    <b onclick="coppy('<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>')"
                            ...
                            <div class="qrbank text-center mt-3">
                                <img src="https://img.vietqr.io/image/ACB-<?php echo e($acb->account_number); ?>-qr_only.jpg?accountName=<?php echo e($acb->account_name); ?>&addInfo=<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>&amount="
                                    alt="QR CODE" width="80%">
                            </div>
                            <!-- Modal -->
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="alert alert-info border border-white fw-bold" role="alert" style="display: flex;">
                            <div style="width: 150%;">
                                <div class="mb-2 ">
                                    <img src="<?php echo e(asset($bidv->logo)); ?>" alt="Logo ACB" width="100" class="text-center">
                                </div>
                                <div class="mb-2">
                                    Số Tài khoản:
                                    <b class="fw-bold cursor-pointer text-success"
                                        onclick="coppy('<?php echo e($bidv->account_number); ?>')">
                                    <?php echo e($bidv->account_number); ?> <i class="fas fa-copy"></i>
                                    </b>
                                </div>
                                <div class="mb-2">
                                    Chủ tài khoản: <b><?php echo e($bidv->account_name); ?></b>
                                </div>
                                <div class="mb-2">
                                    Số tiền tối thiểu: <b><?php echo e(number_format($bidv->min_recharge)); ?> VNĐ</b>
                                </div>
                                <div class="mb-2">
                                    Nội dung chuyển khoản:
                                    <b onclick="coppy('<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>')"
                            ...
                            <div class="qrbank text-center mt-3">
                                <img src="https://img.vietqr.io/image/BIDV-<?php echo e($bidv->account_number); ?>-qr_only.jpg?accountName=<?php echo e($bidv->account_name); ?>&addInfo=<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>&amount="
                                    alt="QR CODE" width="80%">
                            </div>
                            <!-- Modal -->
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="alert alert-primary fw-bold " role="alert" style="display: flex;">
                            <div style="width: 150%;">
                                <div class="mb-2 ">
                                    <img src="<?php echo e(asset($mbbank->logo)); ?>" alt="Logo mbbank" width="100"
                                        class="text-center">
                                </div>
                                <div class="mb-2">
                                    Số Tài khoản:
                                    <b class="fw-bold cursor-pointer text-success"
                                        onclick="coppy('<?php echo e($mbbank->account_number); ?>')">
                                    <?php echo e($mbbank->account_number); ?> <i class="fas fa-copy"></i>
                                    </b>
                                </div>
                                <div class="mb-2">
                                    Chủ tài khoản: <b><?php echo e($mbbank->account_name); ?></b>
                                </div>
                                <div class="mb-2">
                                    Số tiền tối thiểu: <b><?php echo e(number_format($mbbank->min_recharge)); ?> VNĐ</b>
                                </div>
                                <div class="mb-2">
                                    Nội dung chuyển khoản:
                                    <b onclick="coppy('<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>')"
                            ...
                            <div class="qrbank text-center mt-3">
                                <img src="https://img.vietqr.io/image/mbbank-<?php echo e($mbbank->account_number); ?>-qr_only.jpg?accountName=<?php echo e($mbbank->account_name); ?>&addInfo=<?php echo e(siteValue('transfer_code')); ?><?php echo e(Auth::user()->id); ?>&amount="
                                    alt="QR CODE" width="80%">
                            </div>
                            <!-- Modal -->
                ...
                <div class="table-responsive">
                    <table id="dom-table" class="table table-bordered table-hover table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($historys->id); ?></td>
                                <td><span class="badge bg-success"> <?php echo e($historys->bank_code); ?></span></td>
                                <td><span class="badge bg-primary"> <?php echo e($historys->payment_method); ?></span></td>
                                <td><?php echo e($historys->bank_name); ?></td>
                                <td>Không xác định</td>
                                <td><?php echo e(number_format($historys->real_amount)); ?> VNĐ</td>
                                <td><textarea class="form-control" rows="2" style="width: 200px;"
                                    readonly><?php echo e($historys->note); ?></textarea></td>
                                <td><?php echo statusRecharge($historys->status, true); ?></td>
                                <td><?php echo e($historys->created_at); ?></td>
                                <td hidden>
                                    <?php if($historys->status == 'Pending'): ?>
                                    <a href="<?php echo e(route('account.recharge.payment', ['id' => $historys->order_code])); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('guard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tkhosubviptop/public_html/resources/views/guard/recharge.blade.php ENDPATH**/ ?>