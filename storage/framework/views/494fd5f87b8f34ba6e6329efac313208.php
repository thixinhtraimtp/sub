                                ...
                                <?php $__currentLoopData = $allPartnerWebsites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partnerWebsite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if($partnerWebsite->status == 'active'): ?>
                                            <a href="<?php echo e(route('admin.website.partner.deactive', $partnerWebsite->id)); ?>" class="btn btn-danger-gradient btn-sm" data-bs-toggle="tooltip" title="Vô hiệu hoá">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\socialmedia\app\resources\views/admin/partner/website.blade.php ENDPATH**/ ?>