                    ...
                    <table id="data-table" class="table table-hover table-vcenter text-center mb-0">
                        ...
                        <tbody class="fw-bold">
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e($smm->name); ?>" target="blank_"><?php echo e($smm->name); ?></a></td>
                                <td><?php echo e(\Illuminate\Support\Str::limit($smm->token, 20)); ?></td>
                                <td><?php echo e(number_format($smm->balance)); ?> VNĐ</td>
                                <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tkhosubviptop/public_html/resources/views/admin/service/smm.blade.php ENDPATH**/ ?>