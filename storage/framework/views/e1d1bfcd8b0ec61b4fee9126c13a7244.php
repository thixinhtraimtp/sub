  ...
  <div class="container">
    <div class="grid xl:grid-cols-1 gap-6">
      <div class="rounded-lg border border-default-200 bg-white dark:bg-default-50 overflow-hidden">
        <div class="p-5">
          <h5 class="text-red-600 text-xl font-bold text-center">KHI BẠN SỬA DỤNG WEBSITE <?php echo e(site('name_site')); ?></h5>
          ...
          <div class="list-group">
            ...
            <h5 class="text-default-600 text-[30px] font-bold text-center"><?php echo e(site('name_site')); ?> Chân Thành Cảm Ơn Đã Sử Dụng Dịch Vụ.</h5>
          </div>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('guard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seeding1/public_html/resources/views/guard/rule.blade.php ENDPATH**/ ?>