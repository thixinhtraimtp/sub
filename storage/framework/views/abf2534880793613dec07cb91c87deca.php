...
<?php $__env->startSection('title', 'Rút Tiền'); ?>
    ...
    <div class="col-md-5">
        <div class="card ">
            <div class="card-body">
                ...
                <div>
                    <form action="<?php echo e(route('withdraw.create')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-5">
                            <div class="text-danger fw-bold">
                                <i>
                                Số tiền có thể rút: từ
                                <span class="text-primary"><?php echo e(number_format(siteValue('min_withdraw_ref'))); ?> ₫</span> đến <span class="text-success"><?php echo e(number_format(siteValue('max_withdraw_ref'))); ?> ₫</span>
                                <p class="text-danger">Số dư có thể rút của bạn là: <span class="text-warning"><?php echo e(number_format(Auth::user()->referral_money ?? 0) ?: '0đ'); ?></span></p>
                                </i>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="amount" class="form-label">Số Tiền Rút</label>
                            <input type="number" class="form-control" id="amount" name="amount" value="<?php echo e(old('amount')); ?>" >
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="account_number" name="account_number" value="<?php echo e(old('account_number')); ?>" placeholder="Nhập số tài khoản">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="account_name" class="form-label">Chủ Tài Khoản</label>
                                <input type="text" class="form-control" id="account_name" name="account_name" value="<?php echo e(old('account_name')); ?>" placeholder="Nhập tên chủ tài khoản">
                            </div>
                        </div>
                        <div class="mb-3">
            ...
            <div class="card-body">
                <div class="dt-responsive table-responsive">
                    <table class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $withdraws; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdraw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><?php echo e($withdraw->account_name); ?></td>
                                <td>
                    ...
                    <div class="d-flex justify-content-center align-items-center mt-1">
                        <?php echo e($withdraws->appends(request()->all())->links('pagination::bootstrap-4')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('guard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\socialmedia\app\resources\views/guard/affiliate/withdraw.blade.php ENDPATH**/ ?>