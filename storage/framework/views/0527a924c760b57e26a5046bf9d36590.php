...
<div class="row">
    <div class="col-lg-5 col-xxl-3">
        <div class="card overflow-hidden">
            <div class="nav flex-column nav-pills list-group list-group-flush account-pills mb-0" id="setting-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link list-group-item list-group-item-action active" id="setting-1-tab" data-bs-toggle="pill" href="#setting-1" role="tab" aria-controls="setting-1" aria-selected="false" tabindex="-1">
                    <span class="f-w-500" style="display: inline-flex; align-items: center; gap: 8px; font-weight: 500;">
                        <span class="pc-micon" style="display: inline-flex; align-items: center;">
                ...
                <a class="nav-link list-group-item list-group-item-action" id="setting-2-tab" data-bs-toggle="pill" href="#setting-2" role="tab" aria-controls="setting-2" aria-selected="false" tabindex="-1">
                    <span class="f-w-500" style="display: inline-flex; align-items: center; gap: 8px; font-weight: 500;">
                        <span class="pc-micon" style="display: inline-flex; align-items: center;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24">
                ...
                <a class="nav-link list-group-item list-group-item-action" id="setting-3-tab" data-bs-toggle="pill" href="#setting-3" role="tab" aria-controls="setting-3" aria-selected="false" tabindex="-1">
                    <span class="f-w-500" style="display: inline-flex; align-items: center; gap: 8px; font-weight: 500;">
                        <span class="pc-micon" style="display: inline-flex; align-items: center;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M7.843 3.802C9.872 2.601 10.886 2 12 2s2.128.6 4.157 1.802l.686.406c2.029 1.202 3.043 1.803 3.6 2.792c.557.99.557 2.19.557 4.594v.812c0 2.403 0 3.605-.557 4.594s-1.571 1.59-3.6 2.791l-.686.407C14.128 21.399 13.114 22 12 22s-2.128-.6-4.157-1.802l-.686-.407c-2.029-1.2-3.043-1.802-3.6-2.791C3 16.01 3 14.81 3 12.406v-.812C3 9.19 3 7.989 3.557 7s1.571-1.59 3.6-2.792zM13 16a1 1 0 1 1-2 0a1 1 0 0 1 2 0m-1-9.75a.75.75 0 0 1 .75.75v6a.75.75 0 0 1-1.5 0V7a.75.75 0 0 1 .75-.75" clip-rule="evenodd"/></svg>
                        </span>
                        Thông báo khẩn
                    </span>
                </a>
    ...
    <div class="col-lg-7 col-xxl-9">
        <div class="tab-content" id="setting-tabContent">
            <div class="tab-pane fade active show" id="setting-1" role="tabpanel" aria-labelledby="setting-1-tab">
                <div class="card">
            ...
            <div class="tab-pane fade" id="setting-2" role="tabpanel" aria-labelledby="setting-2-tab">
                <div class="card">
                    <div class="card-header">
                        <h5>Thông báo dịch vụ</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="data-table-2" class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Thao tác</th>
            ...
            <div class="tab-pane fade" id="setting-3" role="tabpanel" aria-labelledby="setting-3-tab">
                <div class="card">
                    <div class="card-header">
                        <h5>Thông báo khẩn cấp</h5>
                    </div>
                    <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/seeding1/public_html/resources/views/admin/notification/index.blade.php ENDPATH**/ ?>